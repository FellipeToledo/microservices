...
import com.azvtech.securityservice.auth.validation.password.PasswordMatchingValidator;
import com.azvtech.securityservice.auth.validation.password.StrongPasswordValidator;
...
public class ExceptionHandlerAdvice {
    ...
    Result handleUserAlreadyExistException(UserAlreadyExistsException ex) {
        return new Result(false, StatusCode.CONFLICT,"Usuário já cadastrado!", ex.getMessage());
    }
    ...
    Result handleMalformedJwtException(MalformedJwtException ex) {
        return new Result(false, StatusCode.UNAUTHORIZED, "JWT strings must contain exactly 2 period characters. Found: 0", ex.getMessage());
    }
